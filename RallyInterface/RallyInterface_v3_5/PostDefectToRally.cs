   ...
   public class PostDefectToRally
    {
       ...
       public static void LogDefect(string[] arrayvalues)
       {
           ...
           //var restAPI = new RallyRestApi(Rally_userName, password);
            ...
            //String workspaceRef = "/workspace/19483522386"; SandBOX Workspace
            //String projectRef = "/project/19483522386"; SandBOX Project
            String workspaceRef = "/workspace/11976231838d";
            String projectRef = "/project/11976231838d"; 
           ...
           QueryResult allowedValues = restAPI.GetAllowedAttributeValues("defect", "region");
           ...
           string strDefectState = CommonMethods.Readxmlvalue(strXmlFilePath, strXMLParentNode, "DefectState");
            ...
            Image myImage = Image.FromFile(fullImagePath + fullImageFile);
